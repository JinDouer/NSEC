...
opts['model_path'] = '/home/prisimage/tracker/py-MDNetST/models/imagenet-vgg-m.mat'
#opts['model_path'] = '/home/prisimage/tracker/py-MDNetST/models/mdnet_vot-otb.pth'
opts['img_size'] = 107
opts['padding'] = 16
...
opts['scale_f_expand'] = 2.0

opts['n_bbreg'] = 1000
opts['overlap_bbreg'] = [0.6, 1]
opts['scale_bbreg'] = [1, 2]

opts['lr_init'] = 0.0002#0.0001
opts['maxiter_init'] = 50#40#30
opts['n_pos_init'] = 500
